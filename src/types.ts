...
export interface OpenClawEvent {
  ...
  cleanedBody?: string;
  sessionKey?: string;
  // Quote/reply shapes vary across gateway versions; the handler probes all of them.
  ...
  quoteText?: string;
  replyText?: string;
  reply?: { content?: string; text?: string; body?: string };
  // Assistant-output shapes (output hook).
