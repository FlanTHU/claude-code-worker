...
export declare function classify(content: string, recentMessages: string[], registry: TopicRegistry, config: TopicRouterConfig, llmConfig?: LLMConfig, log?: (...args: unknown[]) => void, lastAssistantReply?: string, freshAutoNewParent?: {
    label: string;
    displayName: string;
} | null): Promise<ClassifyResult>;
